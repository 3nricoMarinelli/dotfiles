# Generated by Powerlevel10k configuration wizard on 2026-01-21 at 15:26 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 37983.
# Wizard options: powerline, unicode, lean, 2 lines, solid, left frame, dark-ornaments,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='sudo@%m'
  # Context format in SSH without privileges
